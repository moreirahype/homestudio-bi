(function () {
  ...
  function applySmallUiFixes() {
    document.querySelectorAll('.insights-weekly-table th').forEach((cell) => {
      if (['Conversas', 'Conv.'].includes(cell.textContent.trim())) cell.textContent = 'Leads';
    });
